...
- *percussion 1 and 2*: F, 8 semitones above the second-lowest A, and E, 11 semitones above that (perc. 1 begins with E)
- *piano and harp*: the lowest A, and the second-lowest A (piano begins with second-lowest A)

The two pairs are positioned with partners facing each other from opposite sides of the piano. The partners for each pair will share two paracord strings, pulling one for either pitch by wrapping it around their hand, and providing slight resistance for the other string. It doesn't particularly matter which cord is in which hand, so long as the two aren't criss-crossing. When one of the players runs out of string, switch directions (pull the other, provide resistence for the previously pulled one).
